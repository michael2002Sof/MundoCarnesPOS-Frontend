    ...
    categorias: [
      {
        ...
        productos: [
          { n: "CARNE DE ASAR", p: "31.000" }, 
          { n: "CHATA", p: "41.000" },
          { n: "AGUJA", p: "42.000" }, 
          { n: "CARNE DE GUISAR", p: "28.000" },
          { n: "COSTILLA DE RES", p: "23.000" }, 
          { n: "PUNTA ANCA", p: "41.000" },
          { n: "HUESO COGOTE", p: "9.000" }, 
          { n: "HUESO ROJO", p: "7.000" },
          { n: "COLA DE RES", p: "24.000" }, 
          { n: "LOMO ANCHO MADURADO", p: "41.000" },
          { n: "UBRE", p: "15.000" }, 
          { n: "CARNE SALADA", p: "30.000" },
          { n: "OSOBUCO", p: "30.000" }, 
          { n: "CARNE CAPON", p: "33.000" },
          { n: "PINCHOS", p: "35.000" }, 
          { n: "TOMAHAWK", p: "48.000" },
          { n: "FAJITAS MADURADAS", p: "35.000" }, 
          { n: "ASADO DE TIRA", p: "27.000" },
          { n: "MILANESA", p: "32.000" }, 
          { n: "CARNE HAMBURGUESA", p: "5.000" },
          { n: "CARNE CHATA PREMIUN", p: "55.000" }, 
          { n: "CARNE PUNTA PREMIUN", p: "55.000" },
          { n: "TUETANO", p: "2.500" },
          { n: "CH DE RES", p: "21.000" },
        ]
      },
      {
        ...
        productos: [
          { n: "CALLO", p: "14.000" }, 
          { n: "BOFE", p: "7.000" },
          { n: "CHINCHULLA", p: "10.000" }, 
          { n: "LENGUA CON AGALLAS", p: "23.000" },
          { n: "CARNE DE PICOS", p: "12.500" }, 
          { n: "HIGADO", p: "19.000" },
          { n: "ASADURA", p: "14.000" }, 
          { n: "ENTRAÑA", p: "21.000" },
          { n: "PATAS DE RES", p: "14.000" }, 
          { n: "LENGUA SIN AGALLAS", p: "29.000" }
        ]
      },
      {
        titulo: "PESCADO",
        productos: [
          ...
          { n: "FILETE DE SALMON 4-6", p: "75.000" }, 
          { n: "BASA KILIADA", p: "9.800" },
          { n: "CAMARON PRECOCIDO", p: "43.800" }, 
      ...
      },
      {
        titulo: "POLLO",
        productos: [
          { n: "POLLO ENTERO", p: "12.000" }, 
          { n: "PERNIL DE POLLO", p: "11.500" },
          { n: "PECHUGA DE POLLO", p: "13.500" }, 
          { n: "ALAS DE POLLO", p: "12.300" },
          { n: "RABADILLA DE POLLO", p: "6.000" }, 
          { n: "BOMBOM DE POLLO", p: "12.700" },
          { n: "CONTRAMUSLO DE POLLO", p: "12.700" }, 
          { n: "MENUDENCIA DE POLLO", p: "1.000" },
          { n: "PATAS DE POLLO", p: "6.000" }, 
          { n: "CORAZON DE POLLO", p: "10.500" },
